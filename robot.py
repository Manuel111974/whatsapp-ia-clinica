...
# 🔹 Configuración de Redis para la memoria de Gabriel
...
def crear_cita(cliente_id, nombre, telefono, fecha, hora, servicio_solicitado, notas="Cita agendada por Gabriel (IA)"):
